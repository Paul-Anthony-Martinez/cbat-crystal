...
# this method stores the current capacity bar in an array to be displayed
...
# the bar is drawn by first drawing the amount of bars representing the current capacity, then 
# the rest by using the same variable in the next while loop.
